...
FROM countries
JOIN cities ON countries.id = cities.country_id -- Joining cities where the countries_id primary key is similar to the foreign key
...
SELECT countries.name AS countries_name, cities.name AS cities_name, cities.district, cities.population
FROM countries
JOIN cities 
